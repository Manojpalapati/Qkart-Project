...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            WebDriverWait wait = new WebDriverWait(driver,30);
            wait.until(ExpectedConditions.or(ExpectedConditions.textToBePresentInElementLocated(By.xpath("//p[text()='YONEX Smash Badminton Racquet']"), product),
            ExpectedConditions.presenceOfElementLocated(By.xpath("(//div[contains(@class,'MuiGrid-root MuiGrid-item')])[2]"))));
            Thread.sleep(3000);
            return true;
        } catch (Exception e) {
